...
# Azure DNS Private Resolver Lab - Testing Instructions
# This script provides instructions for testing the DNS private resolver
# (inbound/outbound endpoints, on-prem forwarding) and DNS security policy via Azure Portal Serial Console

echo "============================================================"
echo "Azure DNS Private Resolver Lab - Testing"
echo "============================================================"
...
echo "============================================================"
echo "DEMO 1: Private Resolver Inbound & On-Prem DNS Forwarding"
echo "============================================================"
echo ""
echo "🔗 Step 1: Access the On-Prem Client VM via Serial Console"
echo "-----------------------------------------------------------"
...
echo "🧪 Step 2: Test Private Endpoint Resolution (from on-prem client)"
echo "---------------------------------------------------------------"
echo ""
...
echo "🔍 Step 3: Verify the Full DNS Chain"
echo "------------------------------------"
...
echo "🖥️  Step 4: (Optional) Verify Windows DNS Server Configuration"
echo "--------------------------------------------------------------"
...
echo ""
echo "Check $ONPREM_DNS_DOMAIN zone and records:"
...
echo ""
echo "============================================================"
echo "DEMO 2: Private Resolver Outbound — Resolve On-Prem DNS from Azure"
echo "============================================================"
echo ""
...
echo "  -> $ONPREM_DNS_DOMAIN zone -> A record"
echo ""
echo "🔗 Step 5: Access the Azure Ubuntu VM via Serial Console"
echo "--------------------------------------------------------"
echo "1. In the Azure Portal, navigate to Virtual Machines"
...
echo "🧪 Step 6: Test Outbound Endpoint Resolution (from Azure VM)"
echo "------------------------------------------------------------"
echo ""
echo "Run these commands from $VM_NAME:"
echo ""
echo "# Resolve the DNS server record in the on-prem $ONPREM_DNS_DOMAIN zone"
echo "dig ${ONPREM_DNS_RECORD_NAME}.${ONPREM_DNS_DOMAIN}"
echo "  # Should return: $DNS_SERVER_STATIC_IP"
echo ""
echo "# Verify the resolution path"
echo "dig ${ONPREM_DNS_RECORD_NAME}.${ONPREM_DNS_DOMAIN} +trace"
echo "  # Azure DNS -> Forwarding Ruleset -> Outbound Endpoint -> Windows DNS"
echo ""
echo "# nslookup alternative"
echo "nslookup ${ONPREM_DNS_RECORD_NAME}.${ONPREM_DNS_DOMAIN}"
echo "  # Should show $DNS_SERVER_STATIC_IP"
echo ""

echo "🔍 Step 7: Verify Outbound Endpoint Chain"
echo "-------------------------------------------"
echo "✅ If dig returns $DNS_SERVER_STATIC_IP: Outbound endpoint works!"
echo "   Azure VM -> Azure DNS -> Forwarding Ruleset -> Outbound Endpoint -> Windows DNS -> $ONPREM_DNS_DOMAIN"
...
echo ""
echo "============================================================"
echo "DEMO 3: DNS Security Policy (Add-on)"
echo "============================================================"
echo ""
echo "🔗 Step 8: Access the Hub VM via Serial Console"
echo "-------------------------------------------"
...
echo "🧪 Step 9: Test DNS Blocking (run these commands in the serial console)"
echo "----------------------------------------------------------------------"
echo ""
...
echo "🔍 Step 10: Verify DNS Security Policy is Working"
echo "-----------------------------------------------"
